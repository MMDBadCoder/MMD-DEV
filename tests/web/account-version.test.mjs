...
test("the customer header and API share release 1.7.0", () => {
  assert.match(read("control/mmd/version.py"), /APP_VERSION = "1\.7\.0"/);
  assert.match(read("web/js/main.js"), /me\?\.version \|\| "1\.7\.0"/);
});
