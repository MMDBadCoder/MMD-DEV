...
const RECOVERY = {
  ...
  no_workspace: ["recovery.workspace", "/console"],
  no_such_workspace: ["recovery.workspace", "/console"],
  ...
  telegram_not_configured: ["recovery.telegram", "/console/account"],
  telegram_bad_token: ["recovery.telegram", "/console/account"],
  telegram_bad_users: ["recovery.telegram", "/console/account"],
  needs_openrouter: ["recovery.openrouter", "/console/ai/openrouter"],
  openrouter_not_ready: ["recovery.retry", null],
  openclaw_not_ready: ["recovery.retry", null],
  busy: ["recovery.retry", null],
  one_key_at_a_time: ["recovery.retry", null],
