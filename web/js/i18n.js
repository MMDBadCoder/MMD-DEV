...
const FA = {
  ...
  "ports.web.preparing": "نشانی HTTPS در حال آماده‌سازی است.",
  "ports.bothproto": "برای برنامه‌های وب از نشانی HTTPS نام‌دار استفاده کنید. نشانی ports نیز با پورت خارجی برای اتصال‌های مستقیم TCP و UDP در دسترس است.",
