...
const FA = {
  ...
  "ssh.keys": "کلیدهای عمومی",
  "ssh.keys.hint": 'محتوای فایل <span class="mono ltr" dir="ltr">~/.ssh/id_ed25519.pub</span> خود را اینجا بگذارید. هر کلید در یک خط.',
  "ssh.keys.none": "هنوز کلیدی ثبت نشده است.",
  "ssh.keys.count": (n) => `${n} کلید ثبت شده`,
  ...
  "ssh.needkey": "برای روشن کردن SSH، ابتدا کلید عمومی خود را وارد کنید.",
  "ssh.enabled": "SSH روشن شد",
  "ssh.disabled": "SSH خاموش شد",
  "ssh.howto": "کلید ندارید؟ در ترمینال خودتان اجرا کنید:",
  ...
  "err.no_ssh_key": "هیچ کلیدی وارد نشده است.",
